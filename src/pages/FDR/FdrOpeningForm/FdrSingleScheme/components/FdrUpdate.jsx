...
import { initialValues, tableHeader } from "./SingleSchemeOpeningForm";
                      ...
                      <div className="   ">
                        <div className="      ">
                          ...
                          <textarea
                            ...
                            name="naration"
                            value={naration}
                            className="  w-9/12     px-2 py-0.5 rounded-[6px] outline-[#000000CC] border-[2px] border-#000000CC bg-primary mb-1.5"
                          />
                        </div>
                      </div>
                    </Flex>
